...
export class CylinderGeometry extends React.Component<{}, IState> {
  public state = {
    height: 10,
    heightSegments: 1,
    openEnded: false,
  ...
  public componentDidMount() {
    this.folder = gui.addFolder("THREE.CylinderGeometry");
    ...
    this.folder.add(data, "radiusTop", 1, 30).onChange(() => this.setState({ radiusTop: data.radiusTop }));
    this.folder.add(data, "radiusBottom", 1, 30).onChange(() => this.setState({ radiusBottom: data.radiusBottom }));
